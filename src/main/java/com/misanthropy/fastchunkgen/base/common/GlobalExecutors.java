...
//    private static final C2MEForkJoinWorkerThreadFactory factory = new C2MEForkJoinWorkerThreadFactory("c2me", "FastChunkGen worker #%d", Thread.NORM_PRIORITY - 1);
    private static final C2MENormalWorkerThreadFactory factory = new C2MENormalWorkerThreadFactory("fastchunkgen", "FastChunkGen worker #%d", Thread.NORM_PRIORITY - 1);
