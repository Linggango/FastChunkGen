package com.misanthropy.fastchunkgen.rewrites.chunk_serializer.common.utils;
...
public class UnsafeUtils {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger("FastChunkGen Chunk Serializer");
                ...
                try {
                    ...
                    return AccessControllerUtils.runWithAccessController(() -> {
                        try {
                            ...
                            LOGGER.warn("sun.misc.Unsafe is unavailable", e);
                            canUseUnsafe = false;
                            return null;
                        }
                    });
