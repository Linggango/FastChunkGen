...
| **Radium** (and Lithium/Canary) | `NbtCompound.copy` and chunk cache on `ServerChunkCache` | We automatically turn off our `MixinNbtCompound`/`MixinNbtList` and chunk-priority mixin when any of these are installed.                                                                                                                          |
